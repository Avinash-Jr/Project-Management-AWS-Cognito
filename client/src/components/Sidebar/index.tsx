...
// import { useGetAuthUserQuery } from "@/state/api"; // ❌ AWS-related
import { useGetProjectsQuery } from "@/state/api";
// import { signOut } from "aws-amplify/auth"; // ❌ AWS-related
import {
  AlertCircle,
  AlertOctagon,
  AlertTriangle,
...
const Sidebar = () => {
  ...
  // ✅ Safe fallback (prevents JSX crashes)
  const currentUserDetails = null;

  // ❌ AWS sign out disabled
  ...
  return (
    <div className={sidebarClassNames}>
      ...
      {/* MOBILE FOOTER (AWS disabled safely) */}
      <div className="z-10 mt-32 flex w-full flex-col items-center gap-4 bg-white px-8 py-4 dark:bg-black md:hidden">
        <div className="flex w-full items-center">
          <div className="flex h-9 w-9 justify-center">
            <User className="h-6 w-6 self-center dark:text-white" />
          </div>
